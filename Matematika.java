...
public class Matematika {
    ...
    void pertambahan(int a, int b, int c) {
        int hasil = a + b + c;
        System.out.println("Hasil Pertambahan int: " + hasil);
    }
    ...
    void pengurangan(int a, int b, int c) {
        int hasil = a - b - c;
        System.out.println("Hasil pengurangan int : " + hasil);
    }
    ...
    void perkalian(int a, int b, int c) {
        int hasil = a * b * c;
        System.out.println("Hasil perkalian int: " + hasil);
    }
    ...
    void pembagian(int a, int b, int c) {
        int hasil = a / b / c;
        System.out.println("Hasil pembagian int : " + hasil);
    }
